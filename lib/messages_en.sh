...
MSG_UNINSTALL_ITEM1="  - Pritunl VM will be destroyed"
MSG_UNINSTALL_ITEM2="  - SDN configuration will be restored to initial state"
MSG_UNINSTALL_ITEM3="  - All network settings will be reverted"
...
MSG_UNINSTALL_STEP1="Step 1: Destroying Pritunl VM..."
MSG_UNINSTALL_STEP2="Step 2: Restoring network configuration..."
