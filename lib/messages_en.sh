...
MSG_UNINSTALL_ITEM4="  - All network configuration will be restored to initial state"
...
MSG_QUOTA_INSTALL_COMPLETE="Quota enforcement installation completed."
MSG_QUOTA_RESTORE_COMPLETE="Quota enforcement restoration completed."
MSG_QUOTA_UNINSTALL_SKIPPED="Quota setup script not found, skipping quota restoration."
MSG_QUOTA_UNINSTALL_WARN="Quota restoration encountered errors (non-fatal)."
