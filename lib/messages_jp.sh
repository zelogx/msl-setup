...
MSG_UNINSTALL_ITEM1="  - Pritunl VMが破棄されます"
MSG_UNINSTALL_ITEM2="  - SDN設定が初期状態に復元されます"
MSG_UNINSTALL_ITEM3="  - すべてのネットワーク設定が元に戻されます"
...
MSG_UNINSTALL_STEP1="ステップ1: Pritunl VMを破棄しています..."
MSG_UNINSTALL_STEP2="ステップ2: ネットワーク設定を復元しています..."
